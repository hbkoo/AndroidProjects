...
public class MainActivity extends AppCompatActivity {
    ...
    private Button camera,photo,open;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera.setOnClickListener(new mClick());
        photo.setOnClickListener(new mClick());
    ...
    private void GetCamera() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            imageUri = FileProvider.getUriForFile(MainActivity.this,
                    "com.example.acer.camera.fileprovider",outputImage);
        } else {
    ...
    private void displayImage(String imagePath) {
        if (imagePath != null) {
            ...
            Bitmap bitmap = fastblur(MainActivity.this,BitmapFactory.decodeFile(imagePath),25);
            image.setImageBitmap(bitmap);
            Toast.makeText(MainActivity.this,"设置成功",
                    Toast.LENGTH_SHORT).show();
        } else {
